...
import com.xiaomi.micolauncher.feature.appmainscreen.folder.FolderPagedView;
import com.xiaomi.micolauncher.feature.appmainscreen.util.FocusLogic;
...
public class FocusHelper {
    ...
    static boolean handleHotseatButtonKeyEvent(View v, int keyCode, KeyEvent e) {
        ...
        final MainAppListFragment launcher = MainAppListFragment.getLauncher(v.getContext());
