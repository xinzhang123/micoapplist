 ...
 */
package com.xiaomi.micolauncher.feature.appmainscreen.views;

import static com.xiaomi.micolauncher.feature.appmainscreen.BaseDraggingActivity.INTENT_EXTRA_IGNORE_LAUNCH_ANIMATION;
import static com.xiaomi.micolauncher.feature.appmainscreen.Utilities.EXTRA_WALLPAPER_OFFSET;
...
public class OptionsPopupView extends ArrowPopup
    ...
    public static void showDefaultOptions(Launcher launcher, float x, float y) {
        ...
        options.add(new OptionItem(R.string.wallpaper_button_text, R.drawable.ic_wallpaper,
                0, OptionsPopupView::startWallpaperPicker));
        options.add(new OptionItem(R.string.widget_button_text, R.drawable.ic_widget,
                0, OptionsPopupView::onWidgetsClicked));
        options.add(new OptionItem(R.string.settings_button_text, R.drawable.ic_setting,
                0, OptionsPopupView::startSettings));
