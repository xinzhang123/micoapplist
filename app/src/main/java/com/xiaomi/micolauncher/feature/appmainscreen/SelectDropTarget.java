...
public class SelectDropTarget extends ButtonDropTarget {

    public SelectDropTarget(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SelectDropTarget(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onFinishInflate() {
        ...
        setDrawable(R.drawable.ic_select_shadow);
    }
