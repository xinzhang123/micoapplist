...
import com.xiaomi.micolauncher.feature.appmainscreen.LauncherProvider.SqlArguments;
...
public class AutoInstallsLayout {
    ...
    protected static String getAttributeValue(XmlResourceParser parser, String attribute) {
        String value = parser.getAttributeValue(
                "http://schemas.android.com/apk/res-auto/com.xiaomi.micolauncher.feature.appmainscreen", attribute);
        if (value == null) {
