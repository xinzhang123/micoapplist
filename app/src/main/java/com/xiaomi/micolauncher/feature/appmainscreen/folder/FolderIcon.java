...
import com.xiaomi.micolauncher.feature.appmainscreen.CheckLongPressHelper;
...
import com.xiaomi.micolauncher.feature.appmainscreen.FolderInfo.FolderListener;
...
import com.xiaomi.micolauncher.feature.appmainscreen.dragndrop.BaseItemDragListener;
        ...
        if (animateView != null) {
            ...
            if (to == null) {
                ...
                if (mLauncher.getStateManager().isScaledState()) {
                    ...
                    int y = lp.y + ((CellLayout) parentChildren.getParent()).getPaddingTop();
...
//            float finalAlpha = index < MAX_NUM_ITEMS_IN_PREVIEW ? 0.5f : 0f;
    ...
    private float getLocalCenterForIndex(int index, int curNumItems, int[] center) {
        mTmpParams = mPreviewItemManager.computePreviewItemDrawingParams(
                Math.min(MAX_NUM_ITEMS_IN_PREVIEW - 1, index), curNumItems, mTmpParams);
